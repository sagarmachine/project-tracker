...
public interface UserRepository extends JpaRepository<User,Long> {
    ...
    @Query(value="select new com.highbrowape.demo.dto.output.UserList(email,firstName,lastName,addedOn) from User where email like %:search% OR firstName like %:search% OR lastName like %:search% ")
